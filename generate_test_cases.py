...
hackathons = [
  ...
  ("Hackathons",
   ...
   "Prize shown as '₹1,00,000' formatted with currency icon and background chip",
   "Prize pool displayed in a prominent, styled badge with icon support.",
   "Pass", "Medium"),
  ...
  ("Hackathons",
   "HACK-004",
   "Hackathon card displays registration deadline",
   "Hackathon entries have variable deadlines fetched from API/Mock",
   "Deadline shown clearly with timer icon and high-contrast color",
   "Registration deadline correctly rendered in the card metadata section.",
   "Pass", "Medium"),
